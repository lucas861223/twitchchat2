...
class MainWidget(QWidget):
    def __init__(self, settingDialog):
        ...
        self.chatFont.setText(file.readline())
        ...
        self.chatFontSize.setText(file.readline())
        ...
        self.chatLineSpacing.setText(file.readline())
    ...
    def chooseFont(self):
        ...
        fontDialog.setCurrentFont(QFont(self.chatFont.text()[:-1], int(self.chatFontSize.text()[:-1]), -1, False))
        fontDialog.exec()
